 ...
 * @author duc_huy_ctlk
 */
public class FormChoMuonThem extends Form {
    ...
    public FormChoMuonThem() {
        super("Thêm khoản cho mượn");

        this.setLayout(new BoxLayout(BoxLayout.Y_AXIS));

        labels = new Label[]{new Label("Số tiền:*"), new Label("Người mượn:*"),
        ...
        btnOK.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (!txtInputs[0].getText().equals("") && !txtInputs[1].getText().equals("")) {
                    ...
                    FormChoMuonThem.this.controller.addMoneyAmount(moneyAmount);

                    FormChoMuonThem.this.removeAll();
                    FormChoMuonThem.this.setEnabled(false);
                    FormChoMuonThem.this.setFocus(false);
                    FormChoMuonThem.this.setVisible(false);

                    FormChoMuonThem.this.owner.setVisible(true);
                    FormChoMuonThem.this.owner.setFocus(true);
                    FormChoMuonThem.this.owner.show();
                }
            }
        });
    ...
    public void setController(FormChoMuonController value) {
