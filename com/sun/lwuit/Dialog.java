...
public class Dialog extends Form {
    ...
    void showModal(int top, int bottom, int left, int right, boolean includeTitle, boolean modal, boolean reverse) {
        ...
        if((!dialogTitleCompatibilityMode) && dialogTitle != null && getUIManager().isThemeConstant("hideEmptyTitleBool", false)) {
    ...
    public Command showPopupDialog(Component c) {
        ...
        if((!dialogTitleCompatibilityMode) && dialogTitle != null && manager.isThemeConstant("hideEmptyTitleBool", false)) {
