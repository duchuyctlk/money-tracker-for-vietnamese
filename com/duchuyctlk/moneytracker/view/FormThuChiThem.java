...
import com.duchuyctlk.moneytracker.controller.ThuChiController;
 ...
 * @author duc_huy_ctlk
 */
public class FormThuChiThem extends Form {
    ...
    public FormThuChiThem() {
        super("Thêm khoản thu/chi");

        this.setLayout(new BoxLayout(BoxLayout.Y_AXIS));

        labels = new Label[]{new Label("Số tiền:*"), new Label("Nội dung:*"),
            ...
            public void actionPerformed(ActionEvent ae) {
                if (!txtInputs[0].getText().equals("") && !txtInputs[1].getText().equals("")) {
                    ...
                    if (chkThu.isSelected())
                        moneyAmount.setLoai(2);
                    else
                        moneyAmount.setLoai(3);
                    ...
                    FormThuChiThem.this.controller.addMoneyAmount(moneyAmount);

                    FormThuChiThem.this.removeAll();
                    FormThuChiThem.this.setEnabled(false);
                    FormThuChiThem.this.setFocus(false);
                    FormThuChiThem.this.setVisible(false);

                    FormThuChiThem.this.owner.setVisible(true);
                    FormThuChiThem.this.owner.setFocus(true);
                    FormThuChiThem.this.owner.show();
                }
            }
        });
        ...
        chkThu = new CheckBox("Khoảng thu?");
    ...
    public void setController(ThuChiController value) {
