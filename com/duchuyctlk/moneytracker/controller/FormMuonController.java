 ...
 * @author duc_huy_ctlk
 */
public class FormMuonController implements IController{

    private FormMuonModel model;
    private DatabaseService db;

    public FormMuonController(IModel value) {
        model = (FormMuonModel) value;
        db = new DatabaseService("thuchi");
    }

    public void loadMoneyAmounts() {
        db.open();
        ArrayList entries = db.readRecords(new String[]{"", "0", "", "", "", ""});
